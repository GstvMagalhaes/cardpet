...
import 'pet-profile-vermifugos.dart';

import 'pet-sign-up-page.dart';

class PetProfileVermifugo2 extends StatefulWidget {
  const PetProfileVermifugo2({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<PetProfileVermifugo2> createState() => _MyPetProfileSignUpState();
}

class _MyPetProfileSignUpState extends State<PetProfileVermifugo2> {
              ...
              child: RaisedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => PetProfileVermifugo(
                        title: '',
                      ),
                    ),
                  );
